...
<head>
    ...
    <title>Dashboard Professionisti - Modifica Account - PatrimoniaExpert</title>
...
<body id="logged-in">
    ...
    <section id="dashboard" class="section-dashboard-professionisti-modifica-account">
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-4 col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                        ...
                        <li class="active"><a href="dashboard-professionista-modifica">Modifica account</a></li>
                    </ul>
                </div>
                        	...
                        	<div class="cont-dash">
                            	...
                            	<div id="modifica-account">
									<div class="col-xs-12">
                                        ...
                                        <!--<form role="form" action="" method="post" class="modifica-account-professionisti-form">
