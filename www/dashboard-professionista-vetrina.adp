                      ...
                      <div class="col-xs-12">
                          <div class="cont-dash">
                              ...
                              <div id="vetrina-dettaglio">
                                    <div class="col-xs-12">
                                        <h2 class="section-heading">Vetrina del Professionista</h2>
                                        <p>Qui puoi modificare i tuoi dati visibili nella vetrina di dettaglio.<br> Ti ricordiamo le <b>dimensioni delle immagini</b> per avere una perfetta risoluzione a schermo:<br>Foto Profilo <b>650px X 650px</b><br>Foto Sfondo <b>1400px X 850px</b><br>La prima volta che inserirai i dati, revisioneremo quanto hai inserito. Non sarà immediatamente visibile a tutti gli utenti di <b>PatrimoniaExpert</b>, ma tu potrai vederne un'anteprima.<br><strong> Si ha solo un'occasione per fare bella impressione!</strong> <br> Il nostro staff ti contatterà in caso ci siano necessità di modifiche.<br>
Vuoi avere un'idea di come sta venendo la tua vetrina? Vuoi controllare che la tua foto profilo sia corretta?<br> Prima salva i dati che hai inserito, premendo il bottone "OK" in fondo, e poi <a href="http://www.patrimoniaexpert.it/professionisti/@permalink@" target="_blank"><strong>guarda l'anteprima</strong></a>!<br>
					  <b>Grazie</b> per la tua collaborazione.</p>					
                                        <formtemplate id="vetrina_form"></formtemplate>
                                    </div>
                              </div>
