...
$(function cropper() {
  ...
  (function() {
    var $image = $('.cropper-user .img-container > img'),
        $dataX = $('#dataX'),
        $dataY = $('#dataY'),
        ...
        options = {
          ...
          // zoomable: false,
           ...
           // minCanvasWidth: 650,
           // minCanvasHeight: 650,
           // minCropBoxWidth: 650, -> NO 650px è rispetto allo schermo e non rispetto l'img
           // minCropBoxHeight: 650, -> NO 650px è rispetto allo schermo e non rispetto l'img
           // minContainerWidth: 650, -> NO grandezza in px del contenitore
           // minContainerHeight: 650,-> NO grandezza in px del contenitore
    ...
    // Methods
    $('.cropper-user').on('click', '[data-method]', function () {
      var data = $(this).data(),
          $target,
          result;
      ...
      $inputImage.change(function () {
        ...
        if (files && files.length) {
          ...
          if (/^image\/\w+$/.test(file.type)) {
            ...
            showMessage('Perfavore, scegli un file immagine.');
          }
        }
      });
    } else {
	...
	/*$('#dashboard .nav-sidebar li > a.link-menu-vetrina-dettaglio').one("click", function() {
		$image.cropper('destroy').cropper(options);
	});
	$('#dashboard .nav-sidebar li > a.link-menu-modifica-account').one("click", function() {
		$image.cropper('destroy').cropper(options);
	});*/
  ...
  (function() {
    var $image = $('.cropper-profile .img-container > img'),
        $dataX = $('#dataX'),
        $dataY = $('#dataY'),
        $dataHeight = $('#dataHeight'),
        $dataWidth = $('#dataWidth'),
    ...
    // Methods
    $('.cropper-profile').on('click', '[data-method]', function () {
      var data = $(this).data(),
          $target,
          result;
