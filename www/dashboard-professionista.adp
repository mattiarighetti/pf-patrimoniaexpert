...
<html lang="en">
  ...
  <head>
    ...
    <title>Dashboard Professionisti - PatrimoniaExpert</title>
...
<section id="dashboard" class="section-dashboard-professionisti">
        <div class="container-fluid">
            <div class="row">
			...
			<li><a href="dashboard-professionista-risposte">Storico risposte date</a></li>
                ...
                <div class="col-xs-offset-4 col-xs-8 col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<p>Nella mail che hai utilizzato per iscriverti, troverai i dati che ti servono per loggarti successivamente a PatrimoniaExpert. Controlla anche la casella di Spam poiché in quella mail troverai una password provvisoria che ti servirà per<strong><a href="http://patrimoniaexpert.it/dashboard-professionista-modifica"> modificare i tuoi dati</a></strong>.</p>
										<p>In quest’area potrai attivare la tua <strong><a href="http://patrimoniaexpert.it/dashboard-professionista-vetrina">Vetrina di dettaglio</a></strong>, essenziale per mostrarti alla rete, e far conoscere le tue aree di competenza a nuovi potenziali investitori. Una volta completata, sarà cura dei moderatori revisionarla prima di farla apparire online.
										<br><br>
Nell’apposita sezione riceverai anche le richieste fatte dai vari investitori finali alla quali ti consigliamo di dare una pronta risposta in modo da migliorare il tuo <strong>rating</strong> e il conseguente <strong>posizionamento</strong> in home page (non ancora completamente disponibili in fase beta).
										<br><br>
Il portale <strong>PatrimoniaExpert</strong> sarà costantemente aggiornato con nuove funzionalità, ti invitiamo pertanto a tornare spesso in questa tua Dashboard per non perderti tutte le nuove possibilità di raggiungere una clientela sempre più qualificata.</p>
                                    </div>
                                </div>        
