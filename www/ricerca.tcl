...
if {[db_0or1row query "select pe.professionista_id, p.first_names, p.last_name, pe.immagine, pe.permalink from pe_professionisti pe, persons p where pe.pending_verification is true and pe.user_id = p.person_id $query_part"]} {
    ...
    set vetrine_html "<center><h3>Nessun professionista corrisponde ai criteri ricercati.</h3></center>"
}
