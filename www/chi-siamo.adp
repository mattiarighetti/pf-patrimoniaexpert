...
<head>
    ...
    <title>Chi siamo - PatrimoniaExpert</title>
...
<body id="page-top">
    ...
    <section class="bg-primary" id="chi-siamo">
    	<div class="full-image"><img src="images/chi-siamo.jpg" class="img-responsive" alt=""></div>
        <div class="container">
            <div class="row">
